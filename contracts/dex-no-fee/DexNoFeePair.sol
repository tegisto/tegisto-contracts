...
import "../dex/interfaces/IDexPair.sol";
import "../dex/DexERC20.sol";
import "../dex/libraries/Math.sol";
import "../dex/libraries/UQ112x112.sol";
import "../dex/interfaces/IERC20.sol";
import "../dex/interfaces/IDexFactory.sol";
import "../dex/interfaces/IDexCallee.sol";

contract DexNoFeePair is IDexPair, DexERC20 {
    ...
    // kLast will not be used because there is no fee
    ...
    function swap(
        ...
        require(amount0In > 0 || amount1In > 0, "Dex: INSUFFICIENT_INPUT_AMOUNT");
        {
            ...
            uint256 balance0Adjusted = balance0; //(balance0.mul(10000).sub(amount0In.mul(25)));
            uint256 balance1Adjusted = balance1; //(balance1.mul(10000).sub(amount1In.mul(25)));
            require(balance0Adjusted.mul(balance1Adjusted) >= uint256(_reserve0).mul(_reserve1), "Dex: K");
        }
